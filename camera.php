...
<div class="area">
			...
			<button type="button" onclick="loadCamera()">Tirar foto e salvar</button>
...
<table class="table_adm">
	<tr>	
		...
		<td>
			<input type="text" id="doc_visitante" name="doc_visitante" maxlength="10" size="40" onblur="verifica_visitante();"/>
		</td>
</tr>	
<tr>
		<td>
...
<tr>	
		...
		<td>
			<input type="text" id="foto_visitante" name="foto_visitante" maxlength="50" size="40"/>
		</td>
</tr>
<tr>	
		<td><br />
...
<tr>
	<td colspan="2"><br />
	<input type="submit" class="submit" value="Autorizar Acesso Visitante" style="width: 100%"/>
	</td>
</tr>
